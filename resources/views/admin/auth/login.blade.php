<x-user-layout>
    ...
    <div class="px-[8%] py-[8%] flex flex-col items-center justify-center relative">
        ...
        {{-- Login form --}}
        <form method="POST" action="{{ route('admin.login') }}" class="p-8 rounded-xl shadow-lg w-[450px] bg-white">
            @csrf

            {{-- Form heading --}}
            <div class="flex flex-col items-center justify-center mb-8">
                <h1 class="text-3xl text-blue-700 font-bold font-poppins">GYM</h1>
                <h1 class="text-lg text-gray-600"> Welcome Admin ! </h1>
            </div>
        ...
        <div class="w-[500px] h-[500px] rounded-full bg-green-500 absolute -z-10 opacity-35 blur-3xl"></div>
    </div>
</x-user-layout>
